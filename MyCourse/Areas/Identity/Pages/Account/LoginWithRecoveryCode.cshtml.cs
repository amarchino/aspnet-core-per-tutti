...
public class LoginWithRecoveryCodeModel : PageModel
{
    ...
    public async Task<IActionResult> OnGetAsync(string? returnUrl = null)
    {
        ...
        var user = await _signInManager.GetTwoFactorAuthenticationUserAsync() ?? throw new InvalidOperationException($"Non è stato possibile trovare l'utente per l'autenticazione due fattori.");
        ReturnUrl = returnUrl;
