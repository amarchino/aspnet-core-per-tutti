...
public class LoginWith2faModel : PageModel
{
    ...
    public async Task<IActionResult> OnGetAsync(bool rememberMe, string? returnUrl = null)
    {
        ...
        var _ = await _signInManager.GetTwoFactorAuthenticationUserAsync() ?? throw new InvalidOperationException($"Non è stato possibile trovare l'utente per l'autenticazione due fattori.");
        ReturnUrl = returnUrl;
